...
/************************************************/
	...
	$next_step 				= (isset($_POST["next_step_radio"]))		? strip_tags(trim($_POST["next_step_radio"]))		 : false;
...
/************************************************/
	...
	/* next_step */
	if ($validate_next_step){
		$result = validateNextStep($next_step, 1);
		if ($result !== "valid") {
			$error_text[] = $result;
		}
	}

	// validate naxt variables
