...
/************************************************/
	...
	define("STEP_USER", "username");					// your username
	define("STEP_SERVER", "host");						// your host
	define("STEP_PASSWORD", "password");				// your password
	define("STEP_DATABASE", "database");				// your database
...
/************************************************/
	if ($duplicate_to_database) {
		...
		if ($mysqli_connect) {
			...
			$row_id = queryMysqli($mysql_table, $name, $way_to_communicate, $email, $email_message, $phone,
											$time, $phone_message);
		}
		...
		if ($pdo_connect) {
			...
			$row_id = queryPdo($mysql_table, $name, $way_to_communicate, $email, $email_message, $phone,
											$time, $phone_message);
		}
	}
