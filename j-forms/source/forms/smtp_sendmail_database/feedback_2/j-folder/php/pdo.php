<?php
	...
	function queryPdo($mysql_table, $name, $email, $department, $message, $product, $service, $support) {
		...
		try {
			...
			$pdo = new PDO("mysql:host=".FB_SERVER.";dbname=".FB_DATABASE."", FB_USER, FB_PASSWORD,
