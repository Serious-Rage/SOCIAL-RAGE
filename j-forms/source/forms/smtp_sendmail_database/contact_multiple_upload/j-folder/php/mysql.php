<?php
	...
	function queryMysqli($mysql_table, $name, $email, $subject, $first_file_name, $second_file_name, $message) {
		...
		$result = mysqli_query($link, "INSERT INTO ".$mysql_table."(`".$mysql_table."_id`,
														...
														VALUES (NULL,	'".mysqli_real_escape_string($link, $name)."',
																		...
																		'".mysqli_real_escape_string($link, $first_file_name)."',
																		'".mysqli_real_escape_string($link, $second_file_name)."',
