<?php
	...
	function queryPdo($mysql_table, $name, $email, $subject, $first_file_name, $second_file_name, $message) {
		...
		try {
			...
			$smt = $pdo->prepare("INSERT INTO ".$mysql_table." (".$mysql_table."_name,
																...
																".$mysql_table."_firstfilename,
																".$mysql_table."_secondfilename,
			...
			$smt -> bindParam(":firstfilename", $first_file_name, PDO::PARAM_STR);
			$smt -> bindParam(":secondfilename", $second_file_name, PDO::PARAM_STR);
