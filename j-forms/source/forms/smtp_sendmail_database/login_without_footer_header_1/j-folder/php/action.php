...
/************************************************/
	...
	define("LOGIN_USER", "username");					// your username
	define("LOGIN_SERVER", "host");						// your host
	define("LOGIN_PASSWORD", "password");				// your password
	define("LOGIN_DATABASE", "database");				// your database
...
/************************************************/
	...
	if ($error_text) {
		...
		echo '<div class="error-message unit">The following errors occurred:<ul>' . $error_message . '</ul></div>';
		exit;
	}
...
/* Success message */
/************************************************/
	echo '<div class="success-message unit">Login and password are correct</div>';
?>