...
/************************************************/
	...
	define("REN_USER", "username");					// your username
	define("REN_SERVER", "host");					// your host
	define("REN_PASSWORD", "password");				// your password
	define("REN_DATABASE", "database");				// your database
...
/************************************************/
	if ($duplicate_to_database) {
		...
		if ($mysqli_connect) {
			...
			$row_id = queryMysqli($mysql_table, $apartment_type, $bedrooms, $bathrooms, $feets, $feets_price,
		...
		if ($pdo_connect) {
			...
			$row_id = queryPdo($mysql_table, $apartment_type, $bedrooms, $bathrooms, $feets, $feets_price,
											 $totals, $name, $email, $phone);
		}
	}
