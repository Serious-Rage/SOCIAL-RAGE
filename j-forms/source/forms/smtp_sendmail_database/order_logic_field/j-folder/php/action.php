...
/************************************************/
	...
	define("FRUIT_USER", "username");					// your username
	define("FRUIT_SERVER", "host");						// your host
	define("FRUIT_PASSWORD", "password");				// your password
	define("FRUIT_DATABASE", "database");				// your database
...
/************************************************/
	if ($duplicate_to_database) {
		...
		if ($mysqli_connect) {
			...
			$row_id = queryMysqli($mysql_table, $first_field, $first_field_quantity, $first_field_price, $first_field_total, $second_field,
		...
		if ($pdo_connect) {
			...
			$row_id = queryPdo($mysql_table, $first_field, $first_field_quantity, $first_field_price, $first_field_total, $second_field,
									$second_field_quantity, $second_field_price, $second_field_total, $third_field, $third_field_quantity,
									$third_field_price, $third_field_total, $field_totals, $name, $email, $phone);
		}
