<?php
	...
	/* Duplicate information to a database */
	function queryMysqli($mysql_table, $login, $pass, $logged_in) {
		...
		$link = mysqli_connect(LOGIN_SERVER, LOGIN_USER, LOGIN_PASSWORD, LOGIN_DATABASE);
		...
		$result = mysqli_query($link, "INSERT INTO ".$mysql_table."(`".$mysql_table."_id`,
														...
														VALUES (NULL,	'".mysqli_real_escape_string($link, $login)."',
																		'".mysqli_real_escape_string($link, $pass)."',
																		'".mysqli_real_escape_string($link, $logged_in)."')");
