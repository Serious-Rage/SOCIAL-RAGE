...
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;">
				...
				<div style="max-width: 600px; display: block; margin: 0 auto;">
					<table style="width: 100%;"><tr>
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;">Dear <span style="font-weight: bold; color: #767b82;">'.$name.',</span> we have received your message successfully. We will contact you as soon as possible.</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Details of your letter:</span></p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">From name: </span>'.$name.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">From email: </span>'.$email.'</p>
								...
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;">Your can contact us using our email: <span style="font-weight: bold; color: #767b82;">'.$your_email.'</span></p>
								</td>
						</tr></table>
</div>
			</td>
