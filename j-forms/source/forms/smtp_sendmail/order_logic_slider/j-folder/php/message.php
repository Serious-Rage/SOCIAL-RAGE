...
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;">
				...
				<div style="max-width: 600px; display: block; margin: 0 auto;">
					<table style="width: 100%;"><tr>
<td>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Apartment type: </span>'.$apartment_type.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Number of bedrooms: </span>'.$bedrooms.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Number of bathrooms: </span>'.$bathrooms.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Square feets quantity: </span>'.$feets.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Price for 100 square feets: </span>$ '.$feets_price.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Total apartment price: </span>$ '.$totals.'</p>
