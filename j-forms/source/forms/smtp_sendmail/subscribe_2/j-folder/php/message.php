...
<td>
								...
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Newsletter type: </span>'.$newsletter.'</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">News type: </span>'.$news.'</p>
							</td>
						</tr></table>
</div>
			</td>
