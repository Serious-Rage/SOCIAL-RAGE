...
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;">
								<h2 style="font-family: Arial, sans-serif; color: #63676d; line-height: 1.2; font-weight: 200; text-align: center; font-size: 28px; margin: 18px 0;" align="center">J-forms: Subscribe form</h2>
							</td>
						</tr></table>
</div>
				<div style="max-width: 600px; display: block; margin: 0 auto;">
					<table style="width: 100%;"><tr>
<td style="border-bottom-width: 1px; border-bottom-color: #f0f0f0; border-bottom-style: solid;>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 15px;">Dear <span style="font-weight: bold; color: #767b82;">'.$first_name.',</span> your subscription to our list has been confirmed.</p>
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;">For your records, here is a copy of the information you submitted to us:</p>
								...
								<p style="margin-bottom: 10px; font-weight: normal; font-size: 14px;"><span style="font-weight: bold; color: #767b82;">Email address: </span>'.$email.'</p>
